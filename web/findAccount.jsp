...
<div class="verify">
    <form action="" onsubmit="return false">
        ...
        <div class="main">
            <ul>
                <p>请输入账号</p>
                <li><input id="item_Uid" type="text" name="uid" placeholder="请输入账号"></li>
                <p>请输入注册手机号</p>
                <li><input id="item_Phone" type="text" name="phone" placeholder="请输入注册手机号"></li>
                <p>请输入邮箱</p>
                <li><input id="item_Email" type="text" name="email" placeholder="请输入邮箱"></li>
                <li class="btnVerify"><input class="btn" type="submit" name="" value="验证" onclick="check()"/></li>
            </ul>
        </div>
    </form>
</div>
<div class="reset">
    <form action="" onsubmit="return checkSumbit()">
        <label>重置密码</label>
        <div class="main">
            <ul>
                <p>请输入密码</p>
